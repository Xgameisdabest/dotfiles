...
OPTIONS=$(python3 "$script_full_path/parser.py" ~/.config/hypr/hyprland_config_modules/keybinds/wm_keybinds.conf && python3 "$script_full_path/parser.py" ~/.config/hypr/hyprland_config_modules/keybinds/special_keybinds.conf)
